            ...
            if (hexValues[currentIndex] === 0xff) {
                ...
                if (hexValues[currentIndex] !== 0x00) {
                    ...
                    if (Object.entries(markerMap)
                        ...
                        .map((k) => k[0])
                        .includes(markerKey)) {
                        let markerUniqKey = createUniqueObjKey(markers, (_a = markerMap[markerKey]) === null || _a === void 0 ? void 0 : _a.name);
                        ...
                        let markerUniqKey = createUniqueObjKey(markers, markerMap[markerKey].name);
                        markers[markerUniqKey] = {
                            marker: markerKey,
                            offset: markerStart,
